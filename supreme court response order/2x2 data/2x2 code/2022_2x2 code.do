** upload the dta **
use "/Users/grantmoore/Dropbox/src 2024/supreme court survey codebooks/cleaned survey data/supremecourtsurveydata2022_cleaned.dta"
...
** save in new folder **
save "/Users/grantmoore/Dropbox/src 2024/supreme court response order/2x2 data/reshaped_2022.dta", replace
...
// Hard coding of SCOTUS decisions (from "2022-SCOTUSpoll-withideal-and-perceptions_statafriendly")
...
//abortion_scotus
replace court_rule = 1 if case_q_order == 2 
//roe_scotus
replace court_rule = 1 if case_q_order == 3 
//guncontrol_scotus
replace court_rule = 1 if case_q_order == 4 
//schoolchoice_scotus
replace court_rule = 1 if case_q_order == 5 
//terrorism_scotus
replace court_rule = 2 if case_q_order == 6 
//freespeech_scotus
replace court_rule = 1 if case_q_order == 7 
//clergy_scotus
replace court_rule = 1 if case_q_order == 8 
//flag_scotus
replace court_rule = 1 if case_q_order == 9 
//smallbizvax_scotus
replace court_rule = 2 if case_q_order == 10 
//healthcarevax_scotus
replace court_rule = 2 if case_q_order == 12 
//epa_scotus
replace court_rule = 2 if case_q_order == 13 
//execpriv_scotus
replace court_rule = 2 if case_q_order == 14 
//schoolprayer_scotus
replace court_rule = 1 if case_q_order == 15 
//immigration_scotus
replace court_rule = 2 if case_q_order == 16 
//nativeamerican_scotus
